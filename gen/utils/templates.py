...
class BKGComparison(ChannelTemplate):
    ...
    samples = {
        'Wjets_emu_Rest': [
            ...
            ['Wjets_emu_Rest_PostProc', proxies.GenericChannel(name="Wjets_emu_Rest", regions_OS=["Wjets_emu_Rest_OS", "Wjets_emu_Rest_SS"], regions_SS=["Wjets_emu_Rest_OS", "Wjets_emu_Rest_SS"])],
        ],
