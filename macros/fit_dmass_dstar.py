...
# histogram names
names = [
    "Wjets_emu_Matched_OS_Dstar_Matched_Dmeson_mdiff",
    "SPG_Matched_OS_Dstar_Matched_Dmeson_mdiff",
    "Wjets_emu_Matched_truth_pt_bin1_OS_Dstar_Matched_truth_pt_bin1_pt_bin1_Dmeson_mdiff",
    "Wjets_emu_Matched_truth_pt_bin2_OS_Dstar_Matched_truth_pt_bin2_pt_bin2_Dmeson_mdiff",
    "Wjets_emu_Matched_truth_pt_bin3_OS_Dstar_Matched_truth_pt_bin3_pt_bin3_Dmeson_mdiff",
    "Wjets_emu_Matched_truth_pt_bin4_OS_Dstar_Matched_truth_pt_bin4_pt_bin4_Dmeson_mdiff",
    "Wjets_emu_Matched_truth_pt_bin5_OS_Dstar_Matched_truth_pt_bin5_pt_bin5_Dmeson_mdiff",
    "SPG_Matched_truth_pt_bin1_OS_Dstar_Matched_truth_pt_bin1_pt_bin1_Dmeson_mdiff",
    "SPG_Matched_truth_pt_bin2_OS_Dstar_Matched_truth_pt_bin2_pt_bin2_Dmeson_mdiff",
    "SPG_Matched_truth_pt_bin3_OS_Dstar_Matched_truth_pt_bin3_pt_bin3_Dmeson_mdiff",
    "SPG_Matched_truth_pt_bin4_OS_Dstar_Matched_truth_pt_bin4_pt_bin4_Dmeson_mdiff",
    "SPG_Matched_truth_pt_bin5_OS_Dstar_Matched_truth_pt_bin5_pt_bin5_Dmeson_mdiff",
]
...
def main(options, args):
    ...
    for name in names:
        ...
        ROOT.myText(0.17, 0.9 - 3 * 0.06, 1, (name.split("_Dmeson_mdiff")[0]).split("Matched_")[-1])
