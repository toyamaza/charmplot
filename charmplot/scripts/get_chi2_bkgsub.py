...
LB = 1.76 #Mass GeV lower bound signal region
...
if __name__ == "__main__":
    ...
    mc_samples_matched = ["Wjets_emu_Matched"]
    ...
    leps = ["el", "mu"]
    years = [""]#2018"]
    pt_bins = ["pt_bin1","pt_bin2","pt_bin3","pt_bin4","pt_bin5"]
    #pt_bins = ["pt_bin4"]#2","pt_bin3","pt_bin4","pt_bin5"]
            ...
            for l in leps:
                for t in ntags:
                    ...
                    for s in mc_samples_matched:
                        if first_hist_mc:
                            mc_sum.Clear()
                            print(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                            mc_sum = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                            mc_sum_Nm1.Clear()
                            mc_sum_Nm1 = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m_" + var_test  + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m_" + var_test  + var_in)
                            mc_sum_Chi2InSB.Clear()
                            mc_sum_Chi2InSB = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in)
                            first_hist_mc = False
                        else:
                            hist = ROOT.TH1F()
                            hist2 = ROOT.TH1F()
                            hist21 = ROOT.TH1F()
                            print(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                            hist = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                            hist21 = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m_" + var_test + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m_" + var_test + var_in)
                            hist2 = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in)
                            print(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                            mc_sum.Add(hist)
                    ...
                    for s in mc_samples:
                        if first_hist_mc_all:
                            mc_sum_all.Clear()
                            mc_sum_all = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                            mc_sum_all_Chi2InSB.Clear()
                            mc_sum_all_Chi2InSB = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in)
                            mc_sum_all_Chi2OutSB_R.Clear()
                            mc_sum_all_Chi2OutSB_L.Clear()
#                            mc_sum_all_Chi2OutSB_R = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB_R" + var_in).Clone()
#                            mc_sum_all_Chi2OutSB_R = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB_R" + var_in).Clone()
                            mc_sum_all_Chi2OutSB_L = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB" + var_in)
                            ...
                            hist4_all = ROOT.TH1F()
                            print(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                            hist_all = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                            hist2_all = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in)
#                            hist3_all = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB_R" + var_in).Clone()
#                            hist4_all = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB_L" + var_in).Clone()
                            hist4_all = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB" + var_in)
                            print(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                    ...
                    for s in data_samples:
                        if first_hist_data:
                            ...
                            data_sum = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                            data_sum_Nm1 = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m_" + var_test + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m_" + var_test + var_in)
                            data_sum_Chi2InSB = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in)
#                            data_sum_Chi2OutSB_R = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB_R" + var_in).Clone()
#                            data_sum_Chi2OutSB_L = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB_L" + var_in).Clone()
                            data_sum_Chi2OutSB_L = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB" + var_in)
                            #print(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m")
                            ...
                            hist5 = ROOT.TH1F()
                            hist = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m" + var_in)
                            hist5 = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m_" + var_test + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m_" + var_test + var_in)
                            hist2 = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_inSB" + var_in)
#                            hist3 = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB_R" + var_in).Clone()
#                            hist4 = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB_L" + var_in).Clone()
                            hist4 = file.Get(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB" + var_in).Clone(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_" + var_test + "_outSB" + var_in)
                            #print(s +  "_" + c + t + "_Dplus_" + b  + "_Dmeson_m")
                            #print (hist)
                            data_sum.Add(hist)
        ...
        for c, d, d_Nm1, mc, mc_Nm1, mc_all, mc_chi2, mc_all_varTest_inSB, mc_all_varTest_outSB_R, mc_all_varTest_outSB_L, data_chi2InSB, data_chi2OutSB_R, data_chi2OutSB_L in zip(charges, data_sums, data_sums_Nm1, mc_sums, mc_sums_Nm1, mc_sums_all, mc_sums_Chi2InSB, mc_sums_all_Chi2InSB, mc_sums_all_Chi2OutSB_R, mc_sums_all_Chi2OutSB_L, data_sums_Chi2InSB, data_sums_Chi2OutSB_R, data_sums_Chi2OutSB_L):
            ...
            data_varTest_OutSB = data_chi2OutSB_L.Clone("data_varTest_OutSB"+c)
            #data_varTest_OutSB.Add(data_chi2OutSB_R)
            ...
            data_varTest_OutSB = ROOT.TH1F()
            data_varTest_OutSB = data_chi2OutSB_L.Clone("data_varTest_OutSB2"+c)
            #data_varTest_OutSB.Add(data_chi2OutSB_R)
            #data_chi2InSB.Add(data_varTest_OutSB,-1*frac2_Nm1)
    ...
    #
            ### Making plots
            c_1 = ROOT.TCanvas(c+b+"1", c+b+"1", 800, 600)
            ...
            d.GetYaxis().SetTitle("Entries")
            d.Draw("")
            line_LB = ROOT.TLine(LB,d.GetMinimum(),LB,d.GetMaximum())
            line_UB = ROOT.TLine(UB,d.GetMinimum(),UB,d.GetMaximum())
            line_LB.Draw("same")
            line_UB.Draw("same")
            ...
            #l1.DrawLatex(0.18, .85, "ATLAS Internal")
            c_1.Print(c + "_" + var_test + "_" + "data_bkg_fit" +"_" +b + ".png")
    ...
    #        canv_5.Print(c + "_" + var_test + "_" + "_data_bkg_fit_Nm1" + ntags[0] +".png")
            ...
            c_12 = ROOT.TCanvas(c+b+"2", c+b+"2", 800, 600)
            #d.GetXaxis().SetRangeUser(135, 180)
            d.Add(bkgHist,-1)
            d.GetYaxis().SetRangeUser(d.GetMinimum(), d.GetMaximum() * 1.3)
            d.GetXaxis().SetTitle("D Mass [GeV]")
            ...
            leg12.Draw()
            #l1.DrawLatex(0.18, .85, "ATLAS Internal")
            c_12.Print(c + "_" + var_test + "_" + "_data_mc_comp" +"_" +b + "_" + sim_title+".png")
    ...
    #        canv_52.Print(c + "_" + var_test + "_" + "_data_mc_comp_Nm1" + ntags[0] +".png")
            ...
            c_3 = ROOT.TCanvas(c+b+"3", c+b+"3", 900, 600)
            #if var_test is "Lxy":
            #    canv.cd(1).SetLogy()
            chi2_fn = ROOT.TF1("chi2_fn", chi2_function, 0, 20.,0)   
            data_intg = data_chi2InSB.Integral(data_chi2InSB.FindBin(LowVal),data_chi2InSB.FindBin(HighVal))
            mc_intg = mc_chi2.Integral(mc_chi2.FindBin(LowVal),mc_chi2.FindBin(HighVal))
            print("mc_intg: "+str(mc_intg))
            print("data_intg: "+str(data_intg))
            data_chi2InSB.Rebin(rebin_int)  
            mc_chi2.Rebin(rebin_int)
            #data_chi2InSB.Scale(mc_intg/data_intg)
            mc_chi2.Scale(data_intg/mc_intg)
            #mc_chi2.SetLineColor(7)
            #chi2_fn.SetLineColor(2)
            data_chi2InSB.GetXaxis().SetTitle(xlabel)
            data_chi2InSB.GetYaxis().SetTitle("a.u.")
            mc_chi2.GetYaxis().SetTitle("a.u.")
            
            #l1 = ROOT.TLatex()
            #l1.SetTextFont(72)
            #l1.SetTextSize(28)
            #l1.DrawLatex(0.18, .85, "ATLAS Internal")
            leg2 = ROOT.TLegend(.55,.60,.9,.95)
            leg2.AddEntry(data_chi2InSB, "Data")
            leg2.AddEntry(mc_chi2, "MC "+sim,"l")
            ...
            data_chi2InSB.GetXaxis().SetTitle(xlabel)
            mc_chi2.GetXaxis().SetTitle(xlabel)
            mc_chi2.SetMarkerSize(0.0)
            #ratio = ROOT.TRatioPlot(mc_chi2,data_chi2InSB)
            ratio = ROOT.TRatioPlot(data_chi2InSB,mc_chi2)
            ratio.GetXaxis().SetRangeUser(LowVal,HighVal)
            ratio.GetXaxis().SetTitle(xlabel)
            line = ROOT.TLine(cut_line,min(data_chi2InSB.GetMinimum(),mc_chi2.GetMinimum()),cut_line,max(data_chi2InSB.GetMaximum(),mc_chi2.GetMaximum())*.85)
            line_rat = ROOT.TLine(cut_line,0.5,cut_line,2.0)
            ratio.SetH1DrawOpt("E0")
            ratio.SetH2DrawOpt("histE0")            
            ratio.Draw("nohide")
            #config upper axis
            ratio.GetUpperRefYaxis().SetTitleOffset(0.9)
            ratio.GetUpperRefYaxis().SetLabelSize(0.0325)
            ratio.GetUpperRefYaxis().SetTitle("a.u.")
            #config lower axis
            ratio.GetLowerRefYaxis().SetTitleOffset(0.9)
            ratio.GetLowerRefYaxis().SetLabelSize(0.0325)
            ratio.GetLowerRefYaxis().SetTitle("ratio")
            ratio.GetLowerRefYaxis().SetNdivisions(10,3,0)
            ratio.GetLowerRefGraph().SetMinimum(0.51)
            ratio.GetLowerRefGraph().SetMaximum(1.9)
            #config x axis
            ratio.GetLowerRefXaxis().SetTitle(xlabel)
            ratio.GetLowerRefXaxis().SetTitleOffset(.75)
            ratio.GetLowerRefXaxis().SetLabelSize(.0325)
            ratio.GetLowerPad().cd()
            line_rat.Draw("same")
            ratio.GetUpperPad().cd()
            line.Draw("same")
            c_3.Update()
            print("norm Check: " + str(data_chi2InSB.Integral(data_chi2InSB.FindBin(LowVal),data_chi2InSB.FindBin(HighVal))) + " : " + str(mc_chi2.Integral(data_chi2InSB.FindBin(LowVal),data_chi2InSB.FindBin(HighVal))))
            #chi2_fn.Draw("same")
            leg2.Draw()
            c_3.Print(c + "_data_"+ var_test +"_" +b +"_"+ sim_title +".png")
            ratio.Clear()
    ...
    #        #mc_all_varTest_inSB.Scale(chi2_fn.InNminus1_cutshapes_06_15_21tegral(0.,20.)/(mc_all_varTest_inSB.Integral() * mc_all_varTest_inSB.GetBinWidth(1)))
